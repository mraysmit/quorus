...
| **RT-02** | Quorus | Concurrency conventions, the task-scope abstraction and the post-Vert.x test standard | 🟨 RT-02a (TaskScope core, [evidence](../evidence/rt-02a-task-scope-2026-09-26.json)) and RT-02b (structured tracing, MDC and declared `ScopedValue` propagation, [evidence](../evidence/rt-02b-context-propagation-2026-09-26.json)) done 2026-09-26; TaskScope 126/126 lines and 52/52 branches. Open: RT-02c concurrency conventions document and the post-Vert.x test standard in plan §6.1 and the Copilot instructions |
