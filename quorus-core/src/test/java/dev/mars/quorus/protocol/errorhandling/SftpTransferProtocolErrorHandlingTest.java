...
/**
 * Error handling tests for SftpTransferProtocol.
 * 
 * <p>These tests verify that the SFTP protocol correctly handles invalid inputs,
...
class SftpTransferProtocolErrorHandlingTest extends ProtocolErrorHandlingTestBase {
    ...
    class DownloadErrorHandlingTests {
        ...
        @Test
        @DisplayName("Transfer should fail with invalid SFTP URI (no path)")
        void transfer_failsWithInvalidSftpUri() {
        ...
        @Test
        @DisplayName("Transfer should fail with SFTP URI missing host")
        void transfer_failsWithSftpUriMissingHost() {
            TransferRequest request = TransferRequest.builder()
        ...
        @Test
        @DisplayName("Transfer should fail with SFTP URI missing path")
        void transfer_failsWithSftpUriMissingPath() {
            TransferRequest request = TransferRequest.builder()
        ...
        void exception_containsProtocolContext() {
            // URI.create("sftp://") throws IllegalArgumentException
            assertThrows(IllegalArgumentException.class, () -> {
                URI.create("sftp://");
            });
    ...
    class UploadErrorHandlingTests {
        ...
        void upload_failsWhenSourceNotExists() {
            ...
            TransferRequest uploadRequest = TransferRequest.builder()
                    ...
                    .destinationUri(URI.create("sftp://testserver/remote/target.txt"))
                    .build();
            ...
            assertTrue(fullMessage.toLowerCase().contains("source") ||
                            ...
                            fullMessage.toLowerCase().contains("sftp"),
                    "Error message should indicate source file or SFTP issue. Got: " + fullMessage);
        }
        ...
        void upload_failsWithEmptyDestinationHost() throws IOException {
            ...
            TransferRequest uploadRequest = TransferRequest.builder()
                    ...
                    .destinationUri(URI.create("sftp:///remote/path/file.txt"))
                    .build();
        ...
        void upload_failsWithEmptyDestinationPath() throws IOException {
            ...
            TransferRequest uploadRequest = TransferRequest.builder()
                    ...
                    .sourceUri(localFile.toUri())
                    .destinationUri(URI.create("sftp://testserver"))
                    .build();
        ...
        void upload_exceptionContainsTransferId() throws IOException {
            ...
            TransferRequest uploadRequest = TransferRequest.builder()
                    ...
                    .sourceUri(localFile.toUri())
                    .destinationUri(URI.create("sftp:///no-host/file.txt"))
                    .build();
