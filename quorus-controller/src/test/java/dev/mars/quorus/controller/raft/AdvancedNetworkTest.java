...
/**
 * Advanced network testing for Raft cluster using Docker Compose.
 * Starts a 5-node containerised cluster to test realistic network scenarios
 * including geographic distribution, network partitions, and complex failure modes.
 * 
